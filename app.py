    ...
    with col1:
        ...
        try:
            ...
            if os.path.exists(image_path):
                ...
                st.info("🛡️ **Safety First in Nairobi**\n\nReport crimes quickly and help make our community safer.")
        except Exception as e:
            st.warning(f"Hero image not found: {str(e)}. Please ensure the image exists in the assets folder.")
